...
def generate_pdf(driver_list, monitor_name, font_size, file_name, column_positions, distance=5):
    with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as buffer:
        ...
        logo_url = "https://github.com/Sidneytitan/ayla/raw/main/Logo.png"  # URL da imagem
        with tempfile.NamedTemporaryFile(delete=False, suffix=".png") as logo_buffer:
            urllib.request.urlretrieve(logo_url, logo_buffer.name)  # Baixa a imagem temporariamente
            ...
            image = ImageReader(logo_buffer.name)
